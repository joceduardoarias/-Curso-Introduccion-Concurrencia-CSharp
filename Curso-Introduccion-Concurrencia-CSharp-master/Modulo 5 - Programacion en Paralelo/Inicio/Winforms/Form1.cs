...
namespace Winforms
{
    public partial class Form1 : Form
    {
        ...
        private async void btnIniciar_Click(object sender, EventArgs e)
        {
            ...
            var OrigenBase = Path.Combine(directorioBase, @"Imagenes\origen");
            ...
            var archivos = Directory.GetFiles(destinoBaseParalela);
            ...
            {
                VoltearImagen(archivo, destinoBaseSecuencial);
            }
            ...
            {
                VoltearImagen(archivo, destinoBaseParalela);
            });
        ...
        {
            using (var bitmap = new Bitmap(archivo))
            {
                bitmap.RotateFlip(RotateFlipType.Rotate180FlipNone);
